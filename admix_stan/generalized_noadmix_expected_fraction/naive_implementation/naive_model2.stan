...
model {
    ...
    for (i in 1:N_obs) {
        if (group[i]==1){
            target += log((dist_fun(N[1],0,T[1],y[i])+exp(-T[1]/N[1])*dist_fun(N_given[1],T[1],T[2],y[i])+exp(-T[1]/N[1])*exp(-T[2]/N_given[1])*dist_fun(N_given[2],T[1]+T[2],100000000,y[i]))/
            (dist_denom(N[1],0,T[1],u[i],v[i])+exp(-T[1]/N[1])*dist_denom(N_given[1],T[1],T[2],u[i],v[i])+exp(-T[1]/N[1])*exp(-T[2]/N_given[1])*dist_denom(N_given[2],T[1]+T[2],100000000,u[i],v[i]))
            );
        }
        if (group[i]==2){
        ...
        if (group[i]==6){
            target += log((dist_fun(N[3],0,T[1]+T[2],y[i]) + exp(-(T[1]+T[2])/N[3])*dist_fun(N_given[2],T[1]+T[2],100000000,y[i]))/(dist_denom(N[3],0,T[1]+T[2],u[i],v[i])+exp(-(T[1]+T[2])/N[3])*dist_denom(N_given[2],T[1]+T[2],100000000,u[i],v[i])));
        }
      }
}